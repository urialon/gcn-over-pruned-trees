...
parser.add_argument('--ga_heads', type=int, default=0, help='Number of GA attention heads.')
parser.add_argument('--ga_every_layer', type=bool, default=False, help='Is GA applied after every layer')
...
parser.add_argument('--label_weight', type=float, default=1.0, help='Weight for labels which are not "no relation".')
